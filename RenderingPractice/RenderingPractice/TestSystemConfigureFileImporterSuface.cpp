...
{
	_entityMap->insert(std::unordered_map<size_t, SystemConfigureEntity*>::value_type(std::hash<std::wstring>{}(L"ScreenResolutionWidth"), new SystemConfigureEntity(L"1920", 1920.0f)));
	_entityMap->insert(std::unordered_map<size_t, SystemConfigureEntity*>::value_type(std::hash<std::wstring>{}(L"ScreenResolutionHeight"), new SystemConfigureEntity( L"1080", 1080.0f)));
	...
	_entityMap->insert(std::unordered_map<size_t, SystemConfigureEntity*>::value_type(std::hash<std::wstring>{}(L"FrustumNearDefault"), new SystemConfigureEntity(L"0.1", 0.1f)));
	_entityMap->insert(std::unordered_map<size_t, SystemConfigureEntity*>::value_type(std::hash<std::wstring>{}(L"FrustumFarDefault"), new SystemConfigureEntity(L"1000", 1000.0f)));
