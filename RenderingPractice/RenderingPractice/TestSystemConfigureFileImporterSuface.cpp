...
bool TestSystemConfigureFileImporterSuface::FileImport()
{
	...
	_entityMap->insert(std::unordered_map<size_t, SystemConfigureEntity*>::value_type(std::hash<std::wstring>{}(L"FrustumNear"), new SystemConfigureEntity(L"0.1", 0.1f)));
	_entityMap->insert(std::unordered_map<size_t, SystemConfigureEntity*>::value_type(std::hash<std::wstring>{}(L"FrustumFar"), new SystemConfigureEntity(L"1000", 1000.0f)));
