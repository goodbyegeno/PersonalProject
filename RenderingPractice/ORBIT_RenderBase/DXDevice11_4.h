...
namespace RenderEngine
{
	...
	public:
		...
		virtual bool Initialize(HWND hwnd, const SystemConfig* systemConfig);
		virtual bool Reset();

		virtual bool	UpdateRenderResolution(const SystemConfig* systemConfig);
		virtual bool	UpdateBackBufferResolution(const SystemConfig* systemConfig);
